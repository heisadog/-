...
function createPage(result) {
    ...
    for (var i = 0; i < result.length; i++) {
        html +=
            ...
            '<li  style="width: 25%;text-indent: 12px;">' + result[i].xtwlmc + '</li>' +
            '<li  style="width: 30%">' + result[i].xtyhxm + '</li>' +
            '<li  style="width: 25%">' + (result[i].xtcqts||'0') + '</li>' +
            '<li style="width: 20%">' + (result[i].xtqkts||'0') + '</li>' +
            '</ul>';
    }
