...
function drawChart(xData, yData) {//根据信息画出图表
    xData = xData || [];
    yData = yData || [];
    var colorData =[]
    var labels = [];
    ...
    var ctx = dom.children("#chart")[0].getContext("2d");
