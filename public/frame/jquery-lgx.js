        ...
        return this.each(function () {
            ...
            reader.onload =function(e){
                ...
                agoimg.onload = function () {
                    ...
                    Cnv.height = (opt.canvasWidth)*m;//该值影响缩放后图片的大小
                    Cnv.width  = opt.canvasWidth ;
                    //img放入画布中
                    //设置起始坐标，结束坐标
                    Cntx.drawImage(imgss, 0, 0,opt.canvasWidth,opt.canvasHeight);
                    var Pic = Cnv.toDataURL("image/png",opt.quality);
                    //Pic = Pic.replace(/^data:image\/(png|jpg);base64,/, "");
                    //console.log(Pic) //这里得到的Pic 就可以进行上传操作等
                    $("#check_img").attr('src',Pic);
                }
