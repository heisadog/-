...
Components.bluetoothPrint._printFormat.LINE_SIZE = localStorage.printFormat == "57" ? 32 : 48;
...
Components.bluetoothPrint._printFormat.PRINTDASHLINE = function () {
    var main = [];
    for (var i = 0; i < Components.bluetoothPrint._printFormat.LINE_SIZE; i++) main.push('-');
    main = main.join('');
    return main;
};
